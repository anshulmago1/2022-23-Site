  ...
  return (
      <footer className="p-6 text-sm">
        <div className="flex items-center mb-2">
          <div className="mr-8">
            <a href="#" className="hover:text-blue-400 transition-all" target="_blank">Join Our Club</a>
          </div>
          <a href="https://www.facebook.com/groups/chscsnhs" target="_blank" className="flex items-center mr-8 hover:text-blue-400 transition-all">
