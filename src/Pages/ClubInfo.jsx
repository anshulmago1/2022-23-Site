...
function ClubInfo() {
  return (
    <div className="flex flex-col items-center">
      <div className="z-10 max-w-7xl py-48 px-6">
        <div className="w-full max-h-screen flex flex-col sm:gap-10 gap-4">
          <h1 className="md:text-7xl sm:text-6xl text-4xl">What is CSNHS?</h1>
          ...
          <h1 className="md:text-7xl sm:text-6xl text-4xl">Why should I join?</h1>
          <p className="sm:text-xl">
